...
from backend.app.app.settings import DATABASES
...
class Provider:
    ...
    def connect():
        ...
        config_connect = "dbname='postgres' user='postgres' host='213.232.228.115' password='PINLOX!@#'"
        connect = psycopg2.connect(config_connect)
